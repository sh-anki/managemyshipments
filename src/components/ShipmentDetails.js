...
class ShipmentDetails extends Component {
    ...
    async handleNameChange() {
        this.setState({ newName: this.textInput.value, showPopup: !this.state.showPopup });
        await _axios.patch("/shipments/" + this.state.shipmentDetails.id, {
                    ...
                    <div className="inner">
                        <table className="shipments-table">
                            ...
                            <tbody>
                                <tr>
                                    <td >Shipment Name</td>
                                    <td >{name}<input type="button" className="edit-button"
                                        value="Update Name"
                                        title="click to change Shipment name"
                                        onClick={this.togglePopup} /></td>
                                </tr>
                                <tr>
                                    <td >Shipment ID</td>
                                    <td >{id}</td>
