    ...
    return (
        <div className="shipment-card">
            <div className="shipment-info">
                ...
                <h5><strong>Origin: </strong>{origin ? origin : "Not Available"}</h5>
                <h5><strong>Destination: </strong>{destination ? destination : "Not Available"}</h5>
                <h5><strong>Mode: </strong>{mode ? mode : "Not Available"}</h5>
            </div>
